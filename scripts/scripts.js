...
/*
  --------------------------------------------------------------------------------------
  Variável para rastrear estados
  --------------------------------------------------------------------------------------
*/
...
/*
  --------------------------------------------------------------------------------------
  Função para atualizar lista (Certifique-se de que 'shwList' está definida!)
  --------------------------------------------------------------------------------------
*/
function toggleList() {
  if (typeof shwList === "function") {
    shwList(); // Chama a função para exibir a lista
  } else {
    console.error("Erro: A função shwList() não está definida!");
  }
}
...
function toggleSearchBox() {
  ...
  const toggleSearchButton = document.querySelector(".intButtons button:nth-child(2)");

  if (!searchBox) {
    console.error("Erro: Elemento searchBox não encontrado!");
    return;
  }
  ...
  if (isSearchVisible) {
    ...
    toggleSearchButton.textContent = "Ocultar Pesquisa";
  }
...
function toggleInsertMedicine() {
  ...
  const insertMedicineButton = document.querySelector(".intButtons button:nth-child(3)");

  if (!insertMedicineForm) {
    console.error("Erro: Elemento .newItem não encontrado!");
    return;
  }

  if (isInsertMedicineVisible) {
    insertMedicineForm.style.display = "none";
    insertMedicineButton.textContent = "Inserir Medicamento";
  } else {
    insertMedicineForm.style.display = "block";
    insertMedicineButton.textContent = "Ocultar Inserção";
  }
...
const config = {
    domain: 'mvpinfomed.us.auth0.com',
    client_id: '9uKkZIcfEukyPNxmDcN2JcCVVnxBiNrz',
...
const authenticateWithGoogle = async () => {
  return new Promise((resolve, reject) => {
    const client = google.accounts.oauth2.initTokenClient({
      client_id: '974715509525-f9lgoopq9c23t3gbmkjunol9uro5dpe0.apps.googleusercontent.com',
